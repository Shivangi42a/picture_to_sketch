...
def dodge(front,back):
        ...
        #if image is greater than 255 which i dont think it is possible but still if it is there then this will convert it to 255
        final_sketch[final_sketch>255]
        final_sketch[back==255]=255
        #to convert any suitable existing column to categorical type we will use aspect function
        #and unit 8 is for 8 bit signed integar
